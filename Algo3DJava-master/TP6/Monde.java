...
public class Monde extends Noeud
{
    ...
    private void prepareScene(){
       //Pomme doree
       //Vecteur3D vecteurT = new Vecteur3D(-10.0f, 11.0f, 75.0f);
       //Transformation translate0 = new Translation(this, vecteurT);
       //Vecteur3D vecteurR = new Vecteur3D(0.0f, 0.0f, 0.0f);
       //Transformation rotate0 = new Rotation(translate0, vecteurR, 10.0f);     
       
       //PommeDoree myPommeDoree = new PommeDoree(rotate0);
       
       //Ciseau
       //Ciseau myCiseau = new Ciseau(this); 
       
       Vecteur3D vecteurTranslate = new Vecteur3D(0.0f, 0.0f, -50.0f);
       Vecteur3D vecteurG1 = new Vecteur3D(0.0f, 0.0f, -9.0f);
       Vecteur3D vecteurD1 = new Vecteur3D(0.0f, 0.0f, -9.0f);
       Vecteur3D vecteurRotate = new Vecteur3D(0.0f, 1.0f, 0.0f);
       
       Transformation translate1 = new Translation(this, vecteurTranslate);
       Transformation rotate1 = new RotationAnimee(translate1, vecteurRotate, 10.0f, 800);
       Ciseau ciseau1 = new Ciseau(rotate1, vecteurD1, 0.0f, 10.0f, 2000);
       // Transformation rotateG1 = new RotationAnimee(rotateD1, vecteurG1, 0.0f, 800);
       // CiseauG CiseauG1 = new CiseauG(rotateG1);       
