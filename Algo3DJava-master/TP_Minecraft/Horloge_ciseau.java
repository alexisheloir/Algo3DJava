...
/**
 * Classe singleton qui représente une Horloge dont l'instance unique 
 ...
 * @version 2019/03/26
 */
public class Horloge_ciseau
{
    // instance variables - replace the example below with your own
    private static Horloge_ciseau m_instanceUnique = null;
     ...
     */
    public static Horloge_ciseau getInstance()
    {
        if (m_instanceUnique == null) {
            m_instanceUnique = new Horloge_ciseau();
        }
