...
public class Monde extends Noeud
{
    ...
    private void prepareScene(){
        ...
        CubeCouleur cube0 = new CubeCouleur(translation0);
        
        Vecteur3D vecteur1 = new Vecteur3D(0.0f,-2.0f,-16.0f);
        Vecteur3D vecteurColor1 = new Vecteur3D(0.0f,1.0f,0.0f);
        Transformation translation1 = new Translation(this, vecteur1);
        CubeCouleur cube1 = new CubeCouleur(translation1, vecteurColor1);
